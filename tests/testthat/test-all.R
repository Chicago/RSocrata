...
test_that("posixify returns Long format", {
  ...
  expect_equal("POSIXlt", class(dt)[1], "first data type of a date")
  expect_equal(2012, dt$year + 1900, "year")
  expect_equal(9, dt$mon + 1, "month")
  expect_equal(14, dt$mday, "day")
  expect_equal(22, dt$hour, "hours")
  expect_equal(38, dt$min, "minutes")
  expect_equal(1, dt$sec, "seconds")
})
...
test_that("posixify returns Short format", {
  ...
  expect_equal(9, dt$mon + 1, "month")
  expect_equal(14, dt$mday, "day")
  expect_equal(0, dt$hour, "hours")
  expect_equal(0, dt$min, "minutes")
  expect_equal(0, dt$sec, "seconds")
})
...
test_that("readSoQL", {
  ...
  expect_equal(1007, nrow(df), "rows")
  expect_equal(1, ncol(df), "columns")
})
...
test_that("Calendar Date Long", {
  ...
  expect_equal("POSIXlt", class(dt)[1], "data type of a date")
  expect_equal(2012, dt$year + 1900, "year")
  expect_equal(9, dt$mon + 1, "month")
  expect_equal(14, dt$mday, "day")
  expect_equal(22, dt$hour, "hours")
...
test_that("Calendar Date Short", {
  ...
  expect_equal("POSIXlt", class(dt)[1], "data type of a date")
  expect_equal(81, dt$year, "year")
  expect_equal(5, dt$mon + 1, "month")
  expect_equal(21, dt$mday, "day")
  expect_equal(0, dt$hour, "hours")
  expect_equal(0, dt$min, "minutes")
  expect_equal(0, dt$sec, "seconds")
})
...
test_that("is 4x4", {
  expect_true(isFourByFour("4334-bgaj"), "ok")
  expect_false(isFourByFour("4334c-bgajc"), "11 characters instead of 9")
  expect_false(isFourByFour("433-bga"), "7 characters instead of 9")
  expect_false(isFourByFour("433-bgaj"), "3 characters before dash instead of 4")
  expect_false(isFourByFour("4334-!gaj"), "non-alphanumeric character")
})
...
test_that("is 4x4 URL", {
  ...
  expect_error(read.socrata("https://soda.demo.socrata.com/api/views/433-bga"), "7 characters instead of 9")
  expect_error(read.socrata("https://soda.demo.socrata.com/api/views/433-bgaj"), "3 characters before dash instead of 4")
  expect_error(read.socrata("https://soda.demo.socrata.com/api/views/4334-!gaj"), "non-alphanumeric character")
})

test_that("Invalid URL", {
  expect_error(read.socrata("a.fake.url.being.tested"), "invalid url")
})
...
test_that("Invalid Socrata domain", {
  expect_error(read.socrata("a.fake.url.being.tested"), "invalid url")
})
